...
## The Dreaded *Adamsitis* Strain of *Ianfluenza* {.smaller}
...
- **Lab 3 (in-class exercise):** data transformation with dplyr — `filter()`, `arrange()`, `mutate()`, `summarize()`, `count()` ([lab page](../labs/lab-03-transform.qmd))
- **Homework 3:** contingency tables, conditional probability, and distributions (posted on the [Session 3 page](../weeks/week-03.qmd))
- **Read before Session 4:** Stanton Ch. 3 · R4DS [Ch. 5 (Data tidying)](https://r4ds.hadley.nz/data-tidy.html)

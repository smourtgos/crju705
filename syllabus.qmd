...
**In-class exercise (graded)** · **Homework:** Problem set 3 (includes the **R4DS Ch. 5 exercises**) · Read Stanton Ch. 3 and R4DS Ch. 5

## `r session_headers[4]`

**Topics:** Sampling distributions, taught via simulation

**Readings due:** Stanton Ch. 3 · R4DS Ch. 5 (Data tidying)

**In-class exercise (graded)** · **Homework:** Problem set 4 (includes the **R4DS Ch. 10 exercises**) · Read Stanton Ch. 4 and R4DS Ch. 10

## `r session_headers[5]`

**Topics:** The logic of inference using confidence intervals — on real data

**Readings due:** Stanton Ch. 4 · R4DS Ch. 10 (Exploratory data analysis)

**In-class exercise (graded)** · **Homework:** Problem set 5 (includes the **R4DS Ch. 16 exercises**) · Read Stanton Ch. 5 and R4DS Ch. 16 (Factors)

## `r session_headers[6]`

**Topics:** Hypothesis testing — Bayesian vs. traditional (frequentist), with t-tests

**Readings due:** Stanton Ch. 5 · R4DS Ch. 16 (Factors)

**In-class exercise (graded)** · **Homework:** Problem set 6 (includes the R4DS Ch. 17 exercises) · Read R4DS Ch. 17 (Dates and times) · No new Stanton chapter · **Final-project dataset selection is due at Session 7** — come with a candidate and be ready to say what one row represents

## `r session_headers[7]`

**Topics:** **Applied data workshop** — the full pipeline on messy real data: import → tidy → describe → test (frequentist and Bayesian)

**Readings due:** R4DS Ch. 17 (Dates and times)
...
**In-class exercise (graded)** · **Homework:** Problem set 12 (includes **project checkpoint 4**) — due the Sunday *after* this session · **Full project due via Canvas by 11:59 pm on Sunday, `r format(project_due, '%B %d')`**, one week later
...
|:---|:---:|:---|
| Homework, labs & in-class exercises | **45%** | Weekly problem sets (including the R4DS exercises attached to Problem Sets 2–6 and the project checkpoints in Problem Sets 8–12) and the graded in-class exercises |
